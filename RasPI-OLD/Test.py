...
pickle.dump((train_images,train_labels,test_images,test_labels), open("mnist.pkl", "wb"), protocol=pickle.HIGHEST_PROTOCOL)

ti, tl, tei, tel = pickle.load(open("mnist.pkl","rb"))